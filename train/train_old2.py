...
if __name__ == "__main__":
    ...
    test_train_query_dataset =  DatabaseDataset(database_dirs=[query_dir],transform=transform, event_vpr=args.event_vpr, use_dift=args.use_dift, use_timestamps_from_gps=True)
    test_train_database_dataset = DatabaseDataset(database_dirs=database_dirs,transform=transform, event_vpr=args.event_vpr, use_dift=args.use_dift, use_timestamps_from_gps=True)

    if not args.event_vpr:
        dataloader = DataLoader(dataset, batch_size=BATCH_SIZE, shuffle=True, num_workers=24)
        database_loader = DataLoader(databaseDataset, batch_size=BATCH_SIZE*4, shuffle=False, num_workers=16)
        test_query_loader = DataLoader(test_query_dataset, batch_size=BATCH_SIZE*4, shuffle=False, num_workers=16)
        test_database_loader = DataLoader(test_database_dataset, batch_size=BATCH_SIZE*4, shuffle=False, num_workers=16)
        test_train_query_loader = DataLoader(test_train_query_dataset, batch_size=BATCH_SIZE*4, shuffle=False, num_workers=16)
        test_train_database_loader = DataLoader(test_train_database_dataset, batch_size=BATCH_SIZE*4, shuffle=False, num_workers=16)
    else:
        ...
        database_loader = DataLoader(databaseDataset, batch_size=BATCH_SIZE*4, shuffle=False, num_workers=16, collate_fn=collate_database_vpr)
        test_query_loader = DataLoader(test_query_dataset, batch_size=BATCH_SIZE*4, shuffle=False, num_workers=16, collate_fn=collate_database_vpr_test)
        test_database_loader = DataLoader(test_database_dataset, batch_size=BATCH_SIZE*4, shuffle=False, num_workers=16, collate_fn=collate_database_vpr_test)
        test_train_query_loader = DataLoader(test_train_query_dataset, batch_size=BATCH_SIZE*4, shuffle=False, num_workers=16, collate_fn=collate_database_vpr_test)
        test_train_database_loader = DataLoader(test_train_database_dataset, batch_size=BATCH_SIZE*4, shuffle=False, num_workers=16, collate_fn=collate_database_vpr_test)
