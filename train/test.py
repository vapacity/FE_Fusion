...
if __name__ == "__main__":
    ...
    test_query_loader = DataLoader(test_query_dataset, batch_size=BATCH_SIZE*args.test_batch_factor, shuffle=False, num_workers=args.num_workers, collate_fn=partial(collate_database, graph_as_frame=args.graph_as_frame, ))
    test_database_loader = DataLoader(test_database_dataset, batch_size=BATCH_SIZE*args.test_batch_factor, shuffle=False, num_workers=args.num_workers, collate_fn=partial(collate_database, graph_as_frame=args.graph_as_frame))
    test_train_query_loader = DataLoader(test_train_query_dataset, batch_size=BATCH_SIZE*args.test_batch_factor, shuffle=False, num_workers=args.num_workers, collate_fn=partial(collate_database, graph_as_frame=args.graph_as_frame))
    test_train_database_loader = DataLoader(test_train_database_dataset, batch_size=BATCH_SIZE*args.test_batch_factor, shuffle=False, num_workers=args.num_workers, collate_fn=partial(collate_database, graph_as_frame=args.graph_as_frame))
