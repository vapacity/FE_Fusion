...
if __name__ == "__main__":
    ...
    visualization_list = ["evg", "est", "graph"]
    args_for_visualization = [{"event_vpr": False, "graph_as_frame": False, "model_path": "/root/autodl-tmp/FE_Fusion/runs/experiment_3/saved_model/model_FEFusion_epoch_199.pth"}, 
                              {"event_vpr": True, "graph_as_frame": False, "model_path": "/root/autodl-tmp/FE_Fusion/runs/experiment_3/saved_model/model_eventVPR_epoch_199.pth"}, 
                              {"event_vpr": False, "graph_as_frame": True, "model_path": "/root/autodl-tmp/FE_Fusion/runs/experiment_3/saved_model/model_FEFusion_epoch_199.pth"}]
